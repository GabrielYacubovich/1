...
class Asteroid {
  constructor(x, y, size, speed) {
    ...
    update() {
      ...
      this.x += (this.slowMotion ? this.speed * 0.1 : this.speed) * Math.sin(this.rotation) + this.thrustX;
      this.y -= (this.slowMotion ? this.speed * 0.1 : this.speed) * Math.cos(this.rotation) + this.thrustY;
